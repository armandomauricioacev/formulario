...
<head>
    ...
    <title>{{ $titulo }}</title>
    <style>
        /* Fondo claro y tipografía, como estaba originalmente */
        ...
        h2 { font-size: 24px; margin: 0; color: #0f172a; }
        hr { border: none; height: 1px; background: #e5e7eb; margin: 16px 0 24px 0; }

        /* Cuerpo del texto y despedida centrados */
        p { font-size: 16px; line-height: 1.6; margin: 12px 0; color: #374151; }
        .despedida { margin-top: 20px; font-weight: 600; color: #374151; }
